...
if (isset($_POST['update'])) {
    ...
    $sql = "INSERT INTO `notice` (`sub`, `body`, `date`) VALUES ('$subject', '$body', current_timestamp())";
            ...
            <div class="p-3">
                ...
                <main class="h-full overflow-y-auto">
                    <section class="register text-center">
                        <main class="form-signin notice">
                            <form action="#" method="POST">
                                <h1 class="h3 mb-3 fw-normal">Add Notice</h1>


                                <!-- <label for="country" class="form-label">stae</label> -->
                                <div class="form-floating">
                                    <input type="text" class="form-control mb-3" id="floatingInput" placeholder="name@example.com" name="subject" required>
                                    <label for="floatingInput">Subject</label>
                                </div>

                                <div class="form-floating">
                                    <textarea class="form-control mb-3" id="floatingPassword" rows="3" name="body" required></textarea>
                                    <label for="floatingPassword">Notice body</label>
                                </div>
