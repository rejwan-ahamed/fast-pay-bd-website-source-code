    ...
    <section class="register text-center">
        ...
        <main class="form-signin user_details">
            <form action="#" method="POST" name="google-sheet">
                <div class="sent">
                    <h3 id="mess" class="text-center p-3"></h3>
                </div>
                <h1 class="h3 mb-3 fw-normal"> Contact Us</h1>

                <div class="form-floating">
                    <input type="text" class="form-control mb-3" id="floatingInput" placeholder="name@example.com" name="entry.280260890" required>
                    <label for="floatingInput">Name</label>
                </div>
                <div class="form-floating">
                    <input type="email" class="form-control mb-3" id="floatingInput" placeholder="name@example.com" name="entry.2095803480" required>
                    <label for="floatingInput">Email address</label>
                </div>
                <div class="form-floating">
                    <input type="text" class="form-control mb-3" id="floatingInput" placeholder="name@example.com" name="entry.2088224763" required>
                    <label for="floatingInput">Subject</label>
                </div>

                <div class="form-floating">
                    <textarea class="form-control mb-3" id="floatingPassword" rows="3" name="entry.922491713" required></textarea>
                ...
                <button class="w-100 btn btn-lg btn-primary" type="submit" name="register">Send</button>
