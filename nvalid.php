...
<body>
    ...
    <section class="help_notice">
        <main class="help px-3">
            <div class="container">
                <h1 class="mt-5 help_num text-center notvalid">Not a valid exchange method please change the exchange method.</h1>

                <h1 class="mt-5 help_num text-center notvalid_home"><a href="index.php"> <i class="bi bi-arrow-left"></i> Return home</a></h1>
