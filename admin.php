            ...
            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
              ...
              <div>
                ...
                <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                  ...
                  include('connection.php');
                  $tusql = "SELECT * FROM `user_register`";
                  $tuquery = mysqli_query($con, $tusql);
                  $tufetch = mysqli_num_rows($tuquery);
                  echo $tufetch;
                  ?>
                </p>
              </div>
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    $sql = "SELECT * FROM `user_payment`  ORDER BY sno DESC LIMIT 20";
    ...
    function loadXMLDoc() {
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          document.getElementById("p_hold").innerHTML =
            this.responseText;
        }
      };
      xhttp.open("GET", "realtime_ponhold.php", true);
      xhttp.send();
    }
